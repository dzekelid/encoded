...
- name: Bitbucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/encoded/master/_listings/bitbucket/snippets-username-encoded-id-comments-comment-id-parameters.md
x-common:
- type: x-developer
