...
- name: Bitbucket Delete Snippets Username Encoded  Comments Comment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-comments-comment-id-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-comments-comment-id-delete-postman.md
x-common:
- type: x-developer
