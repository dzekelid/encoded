...
- name: Bitbucket Parameters Snippets Username Encoded  Node
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-parameters-postman.md
x-common:
- type: x-developer
