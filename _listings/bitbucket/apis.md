...
- name: Bitbucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-files-path-parameters.md
x-common:
- type: x-developer
