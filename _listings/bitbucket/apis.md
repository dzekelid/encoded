...
- name: Bitbucket Get Snippets Username Encoded  Node  Files Path
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-files-path-get-postman.md
x-common:
- type: x-developer
