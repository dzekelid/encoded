...
- name: Bitbucket Delete Snippets Username Encoded  Node
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-delete-postman.md
x-common:
- type: x-developer
