...
- name: Bitbucket Parameters Snippets Username Encoded  Node  Files Path
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-files-path-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/encoded/master/_listings/bitbucket/snippets-username-encoded-id-node-id-files-path-parameters-postman.md
x-common:
- type: x-developer
